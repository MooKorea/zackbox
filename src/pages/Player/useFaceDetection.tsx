...
export default function useFaceDetection(
  ...
  function handleFaceInRange(
    ...
    setIsAreaFit(tr.x / width - tl.x / width > 0.45);
  ...
  const handleFaceTrack = async (video: HTMLVideoElement, canvas: HTMLCanvasElement) => {
  ...
  return { isInFrame, isAreaFit, dimensions, isFaceDetected, handleFaceTrack };
}
